<template>
  <main class="flex-grow flex flex-col items-center justify-center relative min-h-[calc(100vh-80px)]">
    ...
    <div class="absolute inset-0 z-0 overflow-hidden pointer-events-none">
      <!-- Fondo gestionado dinámicamente desde el panel admin (sección login) -->
      <img
        v-if="heroImage"
        :src="heroImage.url"
...
/**
 * Imagen de fondo del hero — comparte sección "login" porque forma parte
 * del mismo flujo de autenticación. Si la API se cae, se muestra la imagen

    ...
    <div class="w-full px-4 md:px-10 lg:px-20">
      ...
      <div class="flex flex-col md:flex-row justify-between items-center gap-8">
        ...
        <div class="flex gap-6">
          ...
          <!-- Spotify -->
          <a 
            class="size-10 rounded-full bg-surface-dark hover:bg-[#1DB954] text-white flex items-center justify-center transition-colors" 
            href="https://open.spotify.com/intl-es/artist/2SuZxiVemUNCCrzzXZVJg3?si=YrPOm41yTjSty7OHPw6JcA"
            target="_blank"
            rel="noopener noreferrer"
            aria-label="Spotify"
          >
          ...
          <!-- YouTube -->
          <a 
            class="size-10 rounded-full bg-surface-dark hover:bg-[#FF0000] text-white flex items-center justify-center transition-colors" 
            href="https://www.youtube.com/@gienco_band"
            target="_blank"
            rel="noopener noreferrer"
            aria-label="YouTube"
          >
